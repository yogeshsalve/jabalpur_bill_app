...
if(isset($_POST['submit'])){
    ...
    $connect = mysqli_connect("localhost", "root", "", "igjy");
...
S_BILL_AMT,S_GOVT_SUBSIDY,S_MON_BILL,SAMADHAN_ARR,QR_CODE,ADV_PAY_INCENT,ONLINE_REBATE,PROMPT_PAY_INCENT FROM bill_print"; 
